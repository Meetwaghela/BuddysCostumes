    ...
    <div className="container mx-auto p-5">
      ...
      <section className="mb-10">
        ...
        <div className="flex flex-wrap justify-center mt-4">
          <img src="src/assets/Solar/Solar1.jpg" alt="Solar Installation" className="w-1/2 md:w-1/3 p-2" />
          <img src="src/assets/Solar/Solar2.jpg" alt="Energy Savings" className="w-1/2 md:w-1/3 p-2" />
          <img src="src/assets/Solar/Solar3.jpg" alt="Maintenance Support" className="w-1/2 md:w-1/3 p-2" />
        </div>
        <div className="mt-4">
          <video width="100%" 
              autoPlay
              muted 
              loop >
            <source src="src/assets/Solar/Solar5.mp4" type="video/mp4" />
